...
" this is plugins for nvim to make live easier

call plug#begin() " start of plugins input

  Plug 'https://github.com/vim-airline/vim-airline' " status bar on the buttom
...
" next code, it is the standart settings for this coc plugin
...
" Always show the signcolumn, otherwise it would shift the tex each time
